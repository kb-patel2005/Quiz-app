        ...
        <div className="bg-white shadow-lg rounded-xl p-6 hover:shadow-2xl transition transform hover:-translate-y-1 flex flex-col justify-center items-center gap-6 flex-wrap">
            ...
            <div className="w-full space-y-3">
                ...
                <div className="grid sm:grid-cols-2 grid-cols-1 gap-4 text-sm">
                    <div className="bg-teal-50 p-3 rounded-lg shadow-sm font-semibold text-[#01505cef]">Category: {quiz.category}</div>
                    <div className="bg-green-50 p-3 rounded-lg shadow-sm font-semibold text-[#005461]">Difficulty: {quiz.difficulty}</div>
                    <div className="bg-blue-50 p-3 rounded-lg shadow-sm font-semibold text-[#005461]">Questions: {quiz.totalQuestions}</div>
                    <div className="bg-purple-50 p-3 rounded-lg shadow-sm font-semibold text-[#005461]">Time per Question: {quiz.timePerQuestion}</div>
                </div>
